...
public class FrenzyCamera{
    ...
    public static double[] leftPos = {0.6/8.0+offsetX, 2.5/8.0+offsetY}; // era 2
    public static double[] midPos = {4.15/8.0+offsetX, 2.75/8.0+offsetY};//0 = col, 1 = row
