package org.firstinspires.ftc.teamcode.autonomous.inter;
...
import org.firstinspires.ftc.teamcode.autonomous.national.CameraAdjustingSyncedBlueBag;
    ...
    private void initializeTrajectories() {
        ...
        if(teamCompatible == TeamCompatible.BAG_UN_CARRY) {
            ...
            enterWarehouse = drive
                    ...
                    .splineTo(new Vector2d(-4, -6.7), Math.toRadians(-90))
                    .build();
