 ...
 * YES
 */
@Autonomous(name = "Camera Adjusting Synced Red None", group = "Ajustare Joc")
//@Disabled//comment out this line before using
public class CameraAdjustingSyncedRedNone extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (frenzyCamera.getValRight() != 0)
                ...
                armGoTo = 650;
            new SelectionCaseRedNone(this, armGoTo).runAuto();
            telemetry.update();
            sleep(30000);
